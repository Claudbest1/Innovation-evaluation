...
const ProcessSurveyForm = ({ onChange }: { onChange: (data: any) => void }) => {
					...
					<div className="space-y-6">
						...
						<div className="space-y-3">
							<Label className="text-base font-medium">
								1. How new or unique do you perceive this process innovation to
								be compared to existing methods currently in use?
							</Label>
							<RadioGroup
								value={formData.q1}
								onValueChange={(value) =>
					...
					<div className="space-y-6 border-t pt-8">
						...
						<div className="space-y-3">
							<Label htmlFor="q31" className="text-base font-medium">
								31. What aspects of the process do you consider most innovative?
							</Label>
							<textarea
								id="q31"
								value={formData.q31}
